...
CREATE TABLE public.users (
    username_id integer NOT NULL,
    nm_username character varying(22) NOT NULL
);
...
INSERT INTO public.users VALUES (23, 'Jeferson');
INSERT INTO public.users VALUES (24, 'Jefferson');
...
SELECT pg_catalog.setval('public.users_username_id_seq', 24, true);
...
--
-- Name: users users_nm_username_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT users_nm_username_key UNIQUE (nm_username);
